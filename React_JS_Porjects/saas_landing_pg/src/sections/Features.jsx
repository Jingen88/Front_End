...
import {features,details} from "../../constance/Index.jsx";
                    ...
                    <div className="relative flex md:flex-wrap flex-nowrap border-2 border-s3 rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:g7 max-md:border-none max-md:rounded-none max-md:gap-3">
                        {features.map(({ id, icon, caption, title, text, button }) => (
                            ...
                            >
                                ...
                                <h2 className='max-w-50 mb-7 h3 text-p4 max-md:mb-6 max-md:h5 '>{title}</h2>
                        ...
                        <ul className="relative flex justify-around flex-grow px-[5%] border-2 border-s3 rounded-7xl max-md:hidden">
                           <div className="absolute bg-s3/20 top[38%] left-0 right-0 w-full
                           h-[1px] z-10"/>
...
<div className='absolute top-0 bottom-0 left-1/2 bg-s3/20 w-[1px] h-full z-10'/>
                                    ...
                                    border-2 border-s2 rounded-full hover:border-s4
                                    transition-all duration-500 shadow-500 size-20'>
                                        <img src={icon}
                                             alt={title}
                                        className='size-17/20 object-contain z-20'/>
                                    </div>
                                    <h3 className='relative z-2 max-w-36 mx-auto
                                     my-0 base-small text-center uppercase'>{title}</h3>
                                </li>
                            ))}
