...
import {plans} from "../../constance/Index.jsx";
            ...
            {plans.map((plan, index) => (
              <div
                ...
                pricing-plan_last pricing-plan_odd
                 pricing-plan_even relative border-2 
                 p-7 max-xl:min-w-80 max-lg:rounded-3xl
                  xl:w-[calc(33.33%+2px)]">

              {index===1 && (
                <div className='g4 absolute h-330 left-0
                 right-0 top-0 z-1 rounded-tl-3xl  rounded-tr-3xl'/>)}
...
$ {" "}
<CountUp start={plan.priceMonthly}
 end={ isMonthly? plan.priceMonthly : plan.priceYearly} duration={0.4} useEasing={true} preserveValue/>
                  </div>
              ...
              <div className={clsx('bpdy-1 relative z-2 mb-10 w-full border-b-s2 pb-9 text-center text-p4', index===1 && 'border-b')}>
                {plan.caption}
              </div>
...
<div className="mt-10 flex w-full justify-center">
                ...
                {index === 1 && (
                  <p className="small-compact mt-9 text-center text-p3
                   before:mx-2.5 before:content-['-'] after:mx-2.5 after:content-['-']">
                    Limited time offer
                  </p>
                )}
